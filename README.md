...
A token a piece of data usually specific to each individual that lets an application understand who the user is.

- [ ] What steps can you take in your web apps to keep your data secure?
PrivateRoute! and axiosWithAuth to create a token

- [ ] Describe how web servers work.
Web Servers take a data request from the PC and relays data back to the pc
